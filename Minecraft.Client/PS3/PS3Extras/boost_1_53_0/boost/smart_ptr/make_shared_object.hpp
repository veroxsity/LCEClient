...
{
    typedef boost::std::shared_ptr< T > type;
};
...
{
    boost::std::shared_ptr< T > pt( static_cast< T* >( 0 ), BOOST_SP_MSD( T ) );
    ...
    return boost::std::shared_ptr< T >( pt, pt2 );
}
...
{
    boost::std::shared_ptr< T > pt( static_cast< T* >( 0 ), BOOST_SP_MSD( T ), a );
